...
<body class="bg-gradient-to-br from-gray-50 to-gray-100">
                    ...
                    <div class="grid lg:grid-cols-2 gap-6 mb-8">
                        <div class="bg-white rounded-2xl shadow-xl p-6">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <select id="sales-period-selector" class="px-4 py-2 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500">
                    ...
                    <div class="grid lg:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-xl p-6">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <a href="#" onclick="event.preventDefault(); showSection(event, 'users');" class="text-sm text-purple-600 hover:text-purple-700 font-semibold">
                                    Lihat Semua <i class="fas fa-arrow-right ml-1"></i>
                                </a>
                            </div>
                            <div class="space-y-4">
                ...
                <div id="users-section" class="section-content hidden">
                    <div class="bg-white rounded-2xl shadow-xl p-6 mb-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <button onclick="resetUserForm(); openModal('addUserModal')" class="bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 py-3 rounded-xl hover:shadow-lg transition font-semibold">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tbody id="users-table-body" class="divide-y divide-gray-200">
                                    <!-- Users will be rendered dynamically by JavaScript -->
                                </tbody>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tbody id="transactions-table-body" class="divide-y divide-gray-200">
                                    <!-- Transactions will be rendered dynamically by JavaScript -->
                                </tbody>
                            </table>
                        </div>
                    </div>
            ...
            <div class="p-6">
                <form id="userForm" class="space-y-4" onsubmit="saveUser(event)">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Masukkan password">
                        <small class="text-gray-500 text-xs mt-1 block">Kosongkan jika tidak ingin mengubah password (saat edit)</small>
                    </div>
                    <div>
                ...
                <form id="addProductForm" class="space-y-4" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="price" step="0.01" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="0">
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Stok</label>
                        <input type="number" name="stock" step="1" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="0">
                    </div>
                    <div>
    ...
    <script>
        ...
        // Sales Chart - Load real data from API
        let salesChartInstance = null;
        async function loadSalesChart(period = '6months') {
            try {
                const response = await fetch(`${API_BASE}/dashboard/sales-chart?period=${period}`, {
                    headers: {
        ...
        // Load sales chart on page load
        loadSalesChart();
        
        // Add event listener to period selector
        const periodSelector = document.getElementById('sales-period-selector');
        if (periodSelector) {
